...
# from torch.utils.tensorboard import SummaryWriter  # Commented out to avoid protobuf conflicts
# Dummy SummaryWriter to avoid import errors
try:
    from torch.utils.tensorboard import SummaryWriter
except:
    class SummaryWriter:
        """Dummy SummaryWriter for inference-only usage"""
